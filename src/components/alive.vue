  ...
  <div id="live">
    <div class="wrapper" ref="wrapper">
      ...
      <div class="video">
          ...
          <div class="tanmu_scroll" id="tanmuScroll" @click="videoflag()">
            <ul>
              ...
              <li v-for="(item,index) in live" class="normal">
                ...
                <span @click="arrkuty({'id':item.uid})" v-if="item.msgtype=='1'" class="nick">
                  <img style="width:40px;" v-if="item.guizu!=''" :src="guizu2(item.guizu)" alt />
                  <img
                    v-if="item.liangname!='0'"
                    style="width:20px;"
        ...
        <div class="video_status video_status_start">
          <img src="../../static/img/video_start.png" alt />
          {{timerstart}}
        </div>-
        ...
        <div class="input" v-show="valueinput">
          <input type="text" @keypress="CheckInfo" v-model="valueInfo" placeholder="说点什么吧！" />
        ...
        <div
          ...
          style="width:220px;height:40px; position: fixed;bottom:295px;left:0;"
        >
        ...
        <div
          ...
          style="width:220px;height:40px; position: fixed;bottom:240px;left:0;"
        >
          <div class="Banner2" data-id="undefined" @click="videoflag()">
    ...
    <div class="share_info" v-if="share">
      ...
      <ul>
        <li @click="wxshare('session')">
          <span>
            <img src="../../static/img/wxk.png" alt />
          </span>
          微信
        </li>
        <li @click="wxshare('timeline')">
          <span>
            <img src="../../static/img/wxk1.png" alt />
          </span>
          朋友圈
        </li>
        ...
        <li @click="jqsgare()">
          <span>
            <img src="../../static/img/fzk.png" alt />
          </span>
          复制链接
        </li>
        <li>
...
export default {
  ...
  methods: {
    ...
    pleasePK(e) {
      var pktime = 5;
      var msg =
        '{"retcode":"000000","retmsg":"ok","msg":[{"_method_":"testlink","action":"1","msgtype":"10","roomnum":"' +
        e +
        '","user_nicename":"' +
        this.liveCt.user_nicename +
        '","quid":"' +
        this.videoUrl +
        '","buid":"' +
        e +
    ...
    pkFun3(quid, buid) {
      ...
      this.axios
        .post(apiy.live_link_show_live, this.$qs.stringify(json))
        .then(function(res) {
          var dat = res.data;
          if (dat.state == 0) {
            _this.quid = quid;
    ...
    closePK() {
      var _this = this;
      var msg =
        '{"retcode":"000000","retmsg":"ok","msg":[{"_method_":"testlink","action":"9","msgtype":"10","roomnum":"' +
        this.buid +
        '"}]}';
      ...
      this.axios
        .post(apiy.live_unlink_show_live, this.$qs.stringify(json))
        .then(function(res) {
          var dat = res.data;
          if (dat.state == 0) {
            _this.showM(dat.msg);
    ...
    getpkList() {
      var _this = this;
      this.axios.get(apiy.live_pk_link_list).then(function(res) {
        var dat = res.data;
        if (dat.state == 0) {
      ...
      qq.shareNews(
        {
          ...
          description:
            "好久不见,想念你们，如果你也想看看最近我的改变，欢饮来到我的直播间！",
          imgUrl: "",
          type: o
        },
        function(ret, err) {
    ...
    getavatar() {
      ...
      this.axios
        .post(apiy.live_online_user, this.$qs.stringify(json))
        .then(function(res) {
          var dat = res.data;
          if (dat.state == 0) {
    ...
    sendgiftname() {
      ...
      this.axios
        .post(apiy.send_gift, this.$qs.stringify(json))
        .then(function(res) {
    ...
    inituser(o) {
      var _this = this;
      this.axios.get(apiy.setNodeInfo + "?liveuid=" + o).then(function(res) {
        if (res.data.state == 0) {
    ...
    setFollow(o) {
      ...
      var json = { touid: o };
      this.axios
        .post(apiy.give_attention, this.$qs.stringify(json))
        .then(function(res) {
          _this.$root.login(res.data.state);
          var dat = res.data;
          if (dat.state == 0) {
    ...
    closeFollow(o) {
      ...
      var json = { touid: o };
      this.axios
        .post(apiy.cancel_attention, this.$qs.stringify(json))
        .then(function(res) {
          var dat = res.data;
          _this.$root.login(res.data.state);
          _this.getHome();

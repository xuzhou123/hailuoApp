<template>
    <div class="Leaderboard">
        <header>
        <img src="../../static/img/leftx.png"  @click="LinkRouter('/?i=0')" alt=""><i>明星排行榜</i>
      </header>
      <div class="title">
        <div>
        ...
        <ul>
          <li v-if="person[0]!=null&&person[0].user!=null">
            ...
            <div class="livename">
              ...
              <p >共收到<em>{{person[0].total_coin}}</em>钻石</p>
            </div>
          </li>
            ...
            <div class="livename">
             ...
             <p >共收到<em>{{person[1].total_coin}}</em>钻石</p>
            </div>
          </li>
            ...
            <div class="livename">
              ...
              <p >共收到<em>{{person[2].total_coin}}</em>钻石</p>
            </div>
          </li>
            ...
            <div class="livename">
             ...
             <p >共收到<em>{{item.total_coin}}</em>钻石</p>
            </div>
          </li>
        </ul>
...
<script>
    ...
    export default {
        ...
        data(){
          return{
              arr_month_start_ranking_list:[],//月榜-明星榜数据集
              arr_week_start_ranking_list:[],//周榜-明星榜数据集
              arr_day_start_ranking_list:[],//日榜
              livenow:0,
              live:[
                {name:'今日',id:1},
                {name:'周榜',id:2},
      ...
      methods:{
          ...
          livenum(){
            if(this.livenow==2){//明星月榜
                  this.person=this.arr_month_start_ranking_list
            }else if(this.livenow==1){//明星周榜
                  this.person=this.arr_week_start_ranking_list
            }else if(this.livenow==0){//明星日榜单
                  this.person=this.arr_day_start_ranking_list
            }
          },
        getLive(){
            var _this=this
            this.axios.get(api.ranking_list).then((res)=>{
               ...
               _this.arr_month_gift_ranking_list=data.arr_month_gift_ranking_list//每月礼物榜数据集
                _this.arr_day_start_ranking_list=data.arr_day_start_ranking_list//每月礼物榜数据集
               _this.livenum()
            })
        }
      }

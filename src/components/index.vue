<template>
  <div class="page-tabbar">
    ...
    <mt-tabbar
      v-model="selected"
      style="color:#5b5b5b; font-size: 12px;border-top:1px solid #eee;"
      fixed
    >
      ...
      <mt-tab-item @click.native.prevent="videosgift()">
        <i
          class="iconfont"
          style="width:60px; position: absolute;top:-10px;margin-left:-15px;"
          slot="icon"
        >
...
export default {
  ...
  methods: {
    ...
    getCode() {
      this.axios.get(api.index_check_code).then(function(res) {
...
@font-face {
  ...
  src: url("//at.alicdn.com/t/font_862104_g3g2382fbd.eot?#iefix")

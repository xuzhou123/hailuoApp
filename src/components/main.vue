<template>
    <div class="main">
       <div class="search_id">
            <div class="search">
              <span @click="goRouter('/search')" class="search-span iconfont" style="color:#ccc"><img src="../../static/img/searchkan.png" alt="" /></span>
        ...
        <!--swipeable-->
          ...
          <mt-tab-container-item id="4">
            ...
            <li  @click="goRouter('/Leaderboard')">
              <span><img src="../../static/img/fuhao.png" alt="">富豪排行榜</span>
                <em><img src="../../static/img/right.png" alt=""></em>
            </li>
             <li  @click="goRouter('/Leaderstatr')">
              <span><img src="../../static/img/zhubo.png" alt="">主播排行榜</span>
                <em><img src="../../static/img/right.png" alt=""></em>
            </li>
          </ul>
			  </mt-tab-container-item>
    ...
    export default {
        ...
        methods:{
          ...
          getLive(o){
            ...
            //console.log(json)
            this.axios.post(apiy.index,this.$qs.stringify(json))
            .then(function(res){             
              if(res.data.state==0){
...
.mint-navbar{
 ...
 .page-infinite-loading{
  ...
  .search_id{
    ...
    overflow: hidden;
     background: -webkit-linear-gradient(left, #00d2ff , #0096ff); /* Safari 5.1 - 6.0 */
	  background: -o-linear-gradient(right, #00d2ff, #0096ff); /* Opera 11.1 - 12.0 */
	  background: -moz-linear-gradient(right, #00d2ff, #0096ff); /* Firefox 3.6 - 15 */
